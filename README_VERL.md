...
- [Reinforcement Learning from Human Feedback on AMD GPUs with verl and ROCm Integration](https://rocm.blogs.amd.com/artificial-intelligence/verl-large-scale/README_VERL.html)
...
and many more awesome work listed in [recipe](recipe/README_VERL.md).
